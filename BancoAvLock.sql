...
CREATE TABLE clientes_atendimentos (
    ...
    observacao TEXT,
    nota_do_cliente TEXT,
    avaliacao_do_cliente TEXT,
    relato_do_operador TEXT,
    tipo_de_atendimento TEXT,
    tipo_de_fechamento TEXT,
    CONSTRAINT atendimentos_pkey PRIMARY KEY (id_atendimento),    
    CONSTRAINT atendimentos_id_cliente_fkey FOREIGN KEY (id_cliente)
        REFERENCES clientes (id_cliente)
);